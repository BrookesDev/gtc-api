            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="fs-17 font-weight-600 mb-0 textInput">All Roles</h6>
                        </div>
                                ...
                                @foreach ($roles as $role)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <a  href="{{ route('edit_role', $role->id) }}" class="btn btn-success-soft btn-sm mr-1"><i class="far fa-eye"></i></a>

                                            <a  href="javascript:void(0);" class="btn btn-danger-soft btn-sm" id="deleteRecord" data-rolename="{{ $role->name }}" data-id="{{ $role->id }}">
