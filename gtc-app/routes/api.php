    ...
    Route::group(['middleware' => ['auth:sanctum']], function () {
        ...
        Route::group(['prefix' => 'payroll'], function () {
            ...
            Route::group(['prefix' => 'allowance'], function () {
                ...
                //specification
                Route::get('/specification', [App\Http\Controllers\AllowanceController::class, 'specification'])->name('api_allowances_specification_home');
                Route::post('/specify_new_allowance', [App\Http\Controllers\AllowanceController::class, 'specifyNewAllowance'])->name('api_specify_new_allowance');
                Route::get('/del_specification', [App\Http\Controllers\AllowanceController::class, 'deleteSpec'])->name('api_delete_allowance_specification');
