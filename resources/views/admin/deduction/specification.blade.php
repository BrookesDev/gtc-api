        ...
        <div class="col-sm-8 header-title p-0">
            <div class="media">
                ...
                <div class="media-body">
                    <h1 class="font-weight-bold">Manage Deduction Specification</h1>
                    <small>Manage Deductions for all levels</small>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="body-content">
        ...
        <div class="col-lg-12">
            <div class="card">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-right">
                            <button type="button" class="btn btn-info rounded-pill w-100p btn-sm mr-1"
                                data-toggle="modal" data-target="#exampleModal1">Add New Deduction</button>
                ...
                <div class="card-body">
                    <p style="display: none" id="deleteURL">{{ route('delete_deduction_specification') }}</p>
                    <div class="table-responsive">
                        <table id="example" class="table table-striped table-bordered nowrap  dt-responsive">
                            ...
                            <tbody>
                                ...
                                @foreach ($deductions as $spec)
                                    <tr>
                                        <td>{{ $loop->iteration }}  </td>
                                        <td> {{ $spec->Deduction->description }} </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-600" id="exampleModalLabel4">Add New Deduction Type</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('specify_new_deduction') }}" method="post" onsubmit="$('#loaderg').show()">
                    @csrf
                    <div class="modal-body">
                        
                        <div class="form-group">
                            <label class="font-weight-600">Deduction Type</label>
                        ...
                        <div class="form-group">
                            ...
                            <input  class="form-control" type="number" name="spec_value" required />                            
                        </div>                     
