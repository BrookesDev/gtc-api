...
@section('content')
        ...
        <div class="col-sm-8 header-title p-0">
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <small>Manage Deduction Types</small>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="body-content">
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p style="display: none" id="deleteURL">{{ route('delete_deduction_type') }}</p>
    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('add_new_DeductionType') }}" method="post" onsubmit="$('#loaderg').show()">
                    @csrf
    ...
    <div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-600" id="exampleModalLabel4">Edit Deduction Type</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('update_deduction_type') }}" method="post" id="editUserform"
