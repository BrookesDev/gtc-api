...
@section('content')
        ...
        <div class="col-sm-8 header-title p-0">
            <div class="media">
                ...
                <div class="media-body">
                    <h1 class="font-weight-bold">Department </h1>
                    <small></small>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="fs-17 font-weight-600 mb-0 textInput">All Department</h6>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <p style="display: none" id="recordURL">{{ route('load_department_data') }}</p>
                        <p style="display: none" id="deleteURL">{{ route('delete_department') }}</p>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-600" id="exampleModalLabel4">Add New Department</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('add_new_department') }}" onsubmit="$('#loaderg').show()" method="POST">
                    @csrf
                    <div class="modal-content">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-600" id="exampleModalLabel4">Edit Department</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('update_department') }}" onsubmit="$('#loaderTest').show()" method="POST">
                    @csrf
                    <div class="modal-content">
                        <div class="modal-body">
...
@section('scripts')
    ...
    @include('includes.department-record-js')
