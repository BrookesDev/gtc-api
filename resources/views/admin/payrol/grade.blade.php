...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="fs-17 font-weight-600 mb-0 textInput">All Grades</h6>
                        </div>
                        <div class="text-right modal-effect ">
                            <button data-effect="effect-super-scaled" data-toggle="modal" data-target="#myModal"
                                ...
                                <i class="fas fa-plus"></i> Create New Grade
                            </button>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <p style="display: none" id="recordURL">{{ route('load_grade_data') }}</p>
                        <p style="display: none" id="deleteURL">{{ route('delete_grade') }}</p>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-600" id="exampleModalLabel4">Add New Grade</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('add_new_grade') }}" onsubmit="$('#loaderg').show()" method="POST">
                    @csrf
                    <div class="modal-content">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-600" id="exampleModalLabel4">Edit Grade</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('update_grade') }}" onsubmit="$('#loaderTest').show()" method="POST">
                    @csrf
                    <div class="modal-content">
                        <div class="modal-body">
                            <input type="hidden" id="recordID" name="id">
                        <div class="form-group">
                            <label class="font-weight-600">Grade:</label>
