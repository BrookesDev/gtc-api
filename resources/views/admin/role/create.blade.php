                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-right">
                            <a href="{{ route('roles_home') }}" class="btn btn-success rounded-pill w-100p btn-sm mr-1">
                                                        ...
                                                        justify-content: center;">
                                                            <div class="toggle">
                                                                ...
                                                                <input type="checkbox" style="visibility:hidden"
                                                                    id="md_checkbox_{{ $value->id }}" name="permission[]"
                                                                    value="{{ $value->id }}">
                                                                <span class="label">Off</span>
            ...
            $('#checkAll').click(function(index, element) {
                ...
                if ($(this).parent().hasClass('on')) {
                    ...
                    $('.slider').each(function(i, obj) {
                        ...
                        $(obj).parent().children('input[type="checkbox"]').prop("checked", false);
